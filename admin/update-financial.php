...
<div class="admin-main-content">
    <h1 style="font-size: 28px; font-weight: 700; margin-bottom: 8px;">
        <i class="fas fa-coins"></i> Student Financial Status
    </h1>
    ...
    <div class="admin-card">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            <!-- Add Payment -->
            <div class="payment-action-panel payment-add-panel">
                ...
                <form method="POST" style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <button type="submit" name="update_payment" class="payment-action-btn payment-add-btn">
            ...
            <!-- Reverse Payment -->
            <div class="payment-action-panel payment-reverse-panel">
                ...
                <form method="POST" style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <button type="submit" name="reverse_payment" class="payment-action-btn payment-reverse-btn" onclick="return confirm('Are you sure you want to reverse this payment? This action cannot be undone.')">
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color: <?php echo $entry['type'] == 'add' ? '#16a34a' : '#dc2626'; ?>; font-weight: 600;">
                                    <i class="fas <?php echo $entry['type'] == 'add' ? 'fa-circle-plus' : 'fa-rotate-left'; ?>"></i>
