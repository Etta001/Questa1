...
<div class="admin-wrapper">
    ...
    <div class="admin-main">
        ...
        <div class="admin-topbar">
            ...
            <div class="admin-theme-switcher" aria-label="Choose appearance">
                <button class="theme-btn admin-theme-btn" data-theme="light" onclick="setTheme('light')" title="Light theme" aria-label="Use light theme"><i class="fas fa-sun"></i></button>
                <button class="theme-btn admin-theme-btn" data-theme="dark" onclick="setTheme('dark')" title="Dark theme" aria-label="Use dark theme"><i class="fas fa-moon"></i></button>
                <button class="theme-btn admin-theme-btn" data-theme="navy" onclick="setTheme('navy')" title="Navy theme" aria-label="Use navy theme"><i class="fas fa-droplet"></i></button>
            </div>
