...
<div class="main-content">
    ...
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Stay informed with the latest announcements from CITEC-HITM</p>
        </div>
        ...
        <?php foreach ($regularNews as $news): ?>
            <div class="news-card" onclick="openNewsModal(<?php echo $news['id']; ?>)">
                <div class="news-category category-<?php echo $news['category']; ?>">
                    ...
                    $categoryIcon = $catIcons[$news['category']] ?? 'fa-newspaper';
                    echo '<i class="fas ' . $categoryIcon . '"></i> ' . ucfirst($news['category']);
                    ?>
                </div>
...
function openNewsModal(newsId) {
    ...
    modalBody.innerHTML = `
        <div class="news-category category-${news.category}">
            <i class="fas ${catIcons[news.category] || 'fa-newspaper'}"></i>
