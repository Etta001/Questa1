...
<div class="main-content">
    ...
    <div class="semester-section">
        <h2 class="section-title"><i class="fas fa-file-lines"></i> First Semester Examinations</h2>
        <div class="exam-grid">
    ...
    <div class="semester-section">
        <h2 class="section-title"><i class="fas fa-file-lines"></i> Second Semester Examinations</h2>
        <div class="exam-grid">
