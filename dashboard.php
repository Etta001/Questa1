...
<div class="main-content">
    ...
    <div class="section-header">
        <h2><i class="fas fa-layer-group"></i> Quick Access</h2>
    </div>
    <div class="features-grid">
        <a href="chatbot.php" class="feature-card">
            <div class="feature-icon" style="background: #fef3c7;"><i class="fas fa-brain" style="color: #d97706;"></i></div>
    ...
    <!-- Recent Papers -->
    <div class="section-header">
        <h2><i class="fas fa-clock-rotate-left"></i> Recently Added Question Papers</h2>
        <a href="question-bank.php" class="view-all-link">Browse All Papers <i class="fas fa-arrow-right"></i></a>
    </div>
