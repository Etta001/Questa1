    ...
    <div class="ai-chatbot" id="aiChatbot">
        ...
        <div class="chatbot-window" id="chatbotWindow">
            <div class="chatbot-header">
                <i class="fas fa-brain"></i> Questa AI Assistant
                <button onclick="toggleChatbot()" aria-label="Close AI assistant"><i class="fas fa-xmark"></i></button>
            </div>
        ...
        modal.innerHTML = `
            <div class="pdf-modal-content">
                <div class="pdf-modal-header">
                    ...
                    <button onclick="closePDFModal()" aria-label="Close document viewer"><i class="fas fa-xmark"></i></button>
                </div>
